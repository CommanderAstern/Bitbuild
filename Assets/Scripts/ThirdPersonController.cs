...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : NetworkBehaviour
    {
        ...
        public float SprintSpeed = 18.335f;
        ...
        private void FixedUpdate()
        {
            ...
            foreach (var collider in colliders)
            {
                ...
                if (collider.CompareTag("Chest") && Input.GetKeyDown(KeyCode.E) && canInteract)
                {
                    ...
                    StartCoroutine(GetRequest("http://13.232.168.166:3000/mintNFT?privateKey="+Web3.Instance.Wallet.Account.PrivateKey.ToString(), collider.transform.parent.gameObject));
                }
            }
        ...
        private void Move()
        {
            ...
            float targetSpeed = _input.sprint ? SprintSpeed*2.25f : MoveSpeed*2.25f;
